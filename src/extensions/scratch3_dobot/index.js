...
class DobotClient{
    ...
    constructor(nid, help_url, runtime) {
...
class DobotExtension{                                                                                                                  
    ...
    getAllPose(args){
        return this.dobot_client.getAllPose(); 
    }
